 ...
 */
public class FrmSala extends javax.swing.JFrame implements PnlObr{
    ...
    public void iniciarSala(Sala sala){
        ...
        agregarComponenteDeSala(new PnlTablero(sala, sala.getMarcador().getJugadores().get(0)));
        agregarComponenteDeSala(new PnlOpt(sala.getMarcador().getJugadores().get(0), this));
